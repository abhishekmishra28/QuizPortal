...
export const getAdminAnalytics = async() => {
    try{
        const response = await axiosInstance.post('/api/reports/admin-analytics')
        return response.data
    }
    catch(error){
        return error.response.data
...
export const getAttemptsByExam = async(payload) => {
    try{
        const response = await axiosInstance.post('/api/reports/getAttemptsByExam', payload)
        return response.data
    }
    catch(error){
        return error.response.data
...
export const getUserAnalytics = async() => {
    try{
        const response = await axiosInstance.post('/api/reports/user-analytics')
        return response.data
    }
    catch(error){
        return error.response.data
